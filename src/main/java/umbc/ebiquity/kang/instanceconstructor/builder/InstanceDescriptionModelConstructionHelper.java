...
import umbc.ebiquity.kang.common.FileUtility;
...
import umbc.ebiquity.kang.instanceconstructor.impl.FileRepositoryConfiguration;
...
public class InstanceDescriptionModelConstructionHelper {
	...
	public static IInstanceDescriptionModel createModel(URL webSiteURL, IInstanceDescriptionModelRepository repo) throws IOException {
		...
		String directory = FileRepositoryConfiguration.getRepositoryDirectoryFullPath();
