...
//		String triple_store_Relations = (String) record.get(ModelRepositorySchemaConfig.TRIPLE_STORE_NUMBER_OF_RELATIONS);
//		String triple_store_Triples = (String) record.get(ModelRepositorySchemaConfig.TRIPLE_STORE_NUMBER_OF_TRIPLES);
